...
| webpage on a website (when authors are the same as the site name) | URL[fn:2]                                         | https://www.cdc.gov/cancer/kinds.htm                                |
...
Guides]], and a blog section of [[https://apastyle.apa.org/blog][Posts]]. I recommend reading the post [[https://apastyle.apa.org/beginners][APA
Style for beginners]], in particular, the 2 minutes demonstrating video
introducing the APA style website. The [[https://extras.apa.org/apastyle/basics-7e/#/][Academic Writer Tutorial]] is
also highly recommended.  [[https://apastyle.apa.org/instructional-aids/beginner-student-paper-checklist.pdf][Student Paper Checklist]] and [[https://apastyle.apa.org/instructional-aids/reference-examples.pdf][Common Reference
Examples Guide]] are also useful. For a comprehensive list of examples,
see the [[https://apastyle.apa.org/style-grammar-guidelines/references/examples][Reference Examples]] page of APA website.
...
[fn:2] The URL or DOI is the final component of a reference list
entry. Do not add a period after the URL and DOI; see the official
guide for [[https://apastyle.apa.org/style-grammar-guidelines/references/dois-urls][DOIs and URLs]].
